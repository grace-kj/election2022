    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines[1:]):
            ...
            if line[2] == "결과":
                ...
                text_b = line[1] + line[4]
            else:
                text_a = line[3] + line[1]
                text_b = line[4] + line[1]
            label = line[5]
...
seq_cls_tasks_num_labels = {"kornli": 3, "nsmc": 2, "paws": 2, "korsts": 1, "question-pair": 2, "hate-speech": 3, "CoLA": 2, "COPA": 2, "BoolQ": 3, "WiC": 2,}
